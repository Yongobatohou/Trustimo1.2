...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light shadow-md accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link hover" href="{{route('get_dashboard')}}">
            ...
            <li class="nav-item">
                <a class="nav-link hover" href="{{route('get_agences')}}">
                    <i class="fas fa-comments fa-cog"></i>
                    <span>Annonceurs</span>
                </a>
                <a class="nav-link hover" href="{{route('get_clients')}}">
                    <i class="fas fa-users fa-cog"></i>
                    <span>Clients</span>
                </a>
                <a class="nav-link hover" href="{{route('get_admins')}}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item hover" href="{{route('get_houses')}}">
                            Maisons
                        </a>
                        <a class="collapse-item hover" href="{{route('get_options')}}">
                            House Options
                        </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseParcelle" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item hover" href="{{route('get_parcelles')}}">
                            Parcelles
                        </a>
                        <a class="collapse-item hover" href="{{route('get_parcel_options')}}">
                            Parcelle Options
                        </a>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{route('admin_logout')}}">Se déconnecter</a>
                </div>
            </div>
        </div>
    </div>
