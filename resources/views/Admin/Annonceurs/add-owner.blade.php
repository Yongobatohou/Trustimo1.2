...
@section('auth')
    ...
    <form class="row g-3" method="POST" action="{{route('add_owner')}}" enctype="multipart/form-data">
        @csrf
        <div class="col-12">
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" name="status" id="statut">
                <option value="">Etes-vous:Démarcheur,Angence Imobilière ou Propriétaire ?</option>
