...
<body class="bg-gradient-light" style="background-image: url(../assets/img/amazone.png); background-size:contain; background-repeat:no-repeat;">

    <div class="container">

        <!-- Outer Row -->
        <div class="row justify-content-center mt-5" style="margin-left: 200px;">
                <div class="card col-6 o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="text-normal text-center py-3">Bon retour chez vous!!!</h2>
                                <div class="px-5">
                                    <form class="user" method="POST" action="{{route('owner_login')}}">
                                        @csrf
